  ...
  return (
    <div className={styles.home}>
      <Meta
        ...
        description="Portfolio of Rishita Badole — a technical writer and software engineer specializing in technical content writing, academic writing, and SEO content writing. Explore my projects and services."
      />
      <Intro
        id="intro"
        sectionRef={intro}
      ...
      <ProjectSummary
        ...
        description="As a contenttttttttt writer, I create compelling landing page copy that highlights the benefits of medical products and services. I help businesses convert website visitors into leads and customers through persuasive and engaging copy."
        buttonText="View Content"
      ...
      <div className={styles.buttonContainer}>
        <Text className={styles.anchorTag}>Software Developer + Technical Content Writer</Text>
